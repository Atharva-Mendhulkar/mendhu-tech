...
export default function KnowledgeArchive({ onOpenGarden }: { onOpenGarden: () => void }) {
  return (
    <section className="pt-8 pb-10 relative z-10">
      ...
      <div 
        className="garden-tile grid grid-cols-1 md:grid-cols-2 gap-6 items-center border border-dotted border-border p-10 bg-card rounded-xl relative z-10 group cursor-pointer hover:border-solid hover:border-accent transition-all duration-300 overflow-hidden fade-in"
