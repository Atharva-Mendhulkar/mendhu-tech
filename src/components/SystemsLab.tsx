            ...
            <div className="flex justify-between items-start mb-2">
              ...
              {project.links.github && (
                <a 
                  ...
                  className="font-mono text-[12px] text-accent border border-dashed border-accent px-4 py-2 rounded-[2px] hover:bg-accent-light transition-all flex items-center gap-2 shrink-0"
                >
